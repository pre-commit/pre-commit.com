            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>(optional) A list of dependencies that will be installed in the environment where this hook gets run. For instance, when using eslint and you would like to add plugins then add them to this parameter.</td>
                    </tr>
                </tbody>
            </table>
            <p>For example:</p>
