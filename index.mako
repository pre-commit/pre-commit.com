...
<div class="col-sm-9">        
    ...
    <div id="install">
        ...
        <pre>curl http://pre-commit.github.io/local-install.py | python</pre>
        ...
        <table class="table table-bordered">
            <tbody>
                <tr>
                    ...
                    <td>where to get plugins (git repos).</td>
                </tr>
                <tr>
                    <td><code>id</code></td>
                ...
                <tr>    
                    ...
                    <td>(optional) Override the default language version for the hook. See <a href="#">Advanced Features: "Overriding Language Version"</a>.</td>
                </tr>
                <tr>
    ...
    <div id="new-hooks"> 
        ...
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <td><code>language_version</code></td>
                    <td>(optional) See <a href="#">Advanced Features: "Overriding Language Version"</a>.</td>
                </tr>
                <tr>
...
<pre>-   id: trailing-whitespace
    ...
    files: \.(js|rb|md|py|sh|txt|yaml|yml)$</pre>
        ...
        <ul>
            ...
            <li><code>pcre</code> - "Perl Compatible Regular Expression" Specify the regex as the entry</li>
...
<pre>$ SKIP=flake8 git commit -m "foo"</pre>
        ...
        <p>The biggest gripe we&rsquo;ve had in the past with pre-commit hooks was during merge conflict resolution. When working on very large projects a merge often results in hundreds of committed files. I shouldn&rsquo;t need to run hooks on all of these files that I didn&rsquo;t even touch! This often led to running commit with <code>--no-verify</code> and allowed introduction of real bugs that hooks could have caught through merge-conflict resolution. pre-commit solves this by only running hooks on files that conflict or were manually edited during conflict resolution.</p>
...
<pre>-   repo: git://github.com/pre-commit/pre-commit-hooks
    ...
    -   id: flake8
        ...
        <h2>Overriding Language Version</h2>
...
<pre>-   repo: git://github.com/pre-commit/mirrors-scss-lint
    ...
    -   id: scss-lint
        ...
        <ul>
            ...
            <li>
                node: See <a href="https://github.com/ekalinin/nodeenv#advanced">https://github.com/ekalinin/nodeenv#advanced</a>.
            </li>
            <li>
                ruby: See <a href="https://github.com/sstephenson/ruby-build/tree/master/share/ruby-build">https://github.com/sstephenson/ruby-build/tree/master/share/ruby-build</a>
            </li>
        </ul>
    </div>
